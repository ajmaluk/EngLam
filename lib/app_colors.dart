...
class AppColors {
  ...
  static const surface2 = Color(0xFF1D1F2D);
  static const border = Color(0xFF2B2F44);

  static const key = Color(0xFF2A2D3A);
  static const actionKey = Color(0xFF202334);
  static const keyPressed = Color(0xFF3A3F55);
